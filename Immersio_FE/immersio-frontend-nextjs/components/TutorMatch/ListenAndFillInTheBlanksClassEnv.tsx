import { IAddDrillForm, IPlanDrill } from '@/src/interfaces/tutorMatch/tutorMatch.interface';
...
const ListenAndFillInTheBlanksClassEnv = (props: IListenAndFillInTheBlanksDrillReview) => {
	const { drill } = props;
...
export default ListenAndFillInTheBlanksClassEnv;
