      ...
      <div className="row">
        <div className="col-xs-12 col-xxl-6 col-xl-6 col-lg-6">
          <div className="feature__content mb-30-mobile">
            <h3>{t('features.immy_chat.title')}</h3>
            <ul>
              <li>{t('features.immy_chat.content_01')}</li>
              <li>{t('features.immy_chat.content_02')}</li>
              <li>{t('features.immy_chat.content_03')}</li>
            </ul>
            <div className="feature__btn d-flex">
              <Link href="/login">
                <a className="tw-inline-block tw-w-full md:tw-w-auto">
                  <Button className="tw-w-full md:tw-w-auto open-speak-default-btn btn">{t('features.immy_chat.btn')}</Button>
                </a>
              </Link>
            </div>
          </div>
        ...
        <div className="col-xs-12 col-xxl-6 col-xl-6 col-lg-6 pl-lg-50 algin-self-center">
          <img src="/assets/img/features/Immychat.png" width="100%" />
        </div>
      </div>
    </div>
  </section>
