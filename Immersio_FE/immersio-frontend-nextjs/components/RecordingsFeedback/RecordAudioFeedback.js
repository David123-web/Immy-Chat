...
const RecordAudioFeedback = ({ uploading =  false, onChange }) => {
    ...
    <>
      ...
      <div className="tw-flex tw-justify-center tw-items-center tw-space-x-4">
        ...
        <Button
          disabled={!src}
          loading={uploading}
          className="bg-theme-3 color-theme-3 color-theme-7"
          onClick={() => setSrc('')}
        >
          Delete
        </Button>
...
export default RecordAudioFeedback